...
public class FlyCamera : MonoBehaviour
{
	...
	*/
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.R)) rotationX += cameraSensitivity * Time.deltaTime;
        if (Input.GetKey(KeyCode.F)) rotationX -= cameraSensitivity * Time.deltaTime;


        if (Input.GetKey(KeyCode.Q)) rotationY -= cameraSensitivity * Time.deltaTime;
        if (Input.GetKey(KeyCode.E)) rotationY += cameraSensitivity * Time.deltaTime;
