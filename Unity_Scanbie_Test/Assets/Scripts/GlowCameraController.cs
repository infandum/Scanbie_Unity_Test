...
/// </summary>
public class GlowCameraController : MonoBehaviour
{
	private static GlowCameraController _instance;

	private CommandBuffer _commandBuffer;

	private List<GlowObjectControl> _glowableObjects = new List<GlowObjectControl>();
